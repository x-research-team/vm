...
import (
	...
	_ "github.com/x-research-team/vm/lexer"
	"github.com/x-research-team/vm/message"
...
func evalInfixExpression(node *ast.InfixExpression, left, right Object, scope *Scope) Object {
	...
	if _, ok := left.(Writable); ok { //There are two Writeables in kernel: FileObject, HttpResponseWriter.
...
func evalClassLiteral(c *ast.ClassLiteral, scope *Scope) Object {
	var parentClass = BASE_CLASS //base class is the root of all classes in kernel
	if c.Parent != "" {
