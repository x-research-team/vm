...
func (gfn *GoFuncObject) CallMethod(line string, scope *Scope, method string, args ...Object) Object {
	...
	// Convert the result back to kernel Object
...
// Kernel language Object to go language Value.
...
// Go language Value to kernel language Object(take care of slice object value)
